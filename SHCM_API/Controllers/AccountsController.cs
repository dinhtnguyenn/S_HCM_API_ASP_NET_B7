...
namespace SHCM_API.Controllers
{
    public class AccountsController : ApiController
    {
        ...
        [HttpPost]
        public IHttpActionResult RegisterAccount(Account account)
        {
        ...
        [HttpPost]
        public IHttpActionResult ChangeInfo(Account account)
        {
            if (!ModelState.IsValid)
            {
            ...
            db.Accounts.AddOrUpdate(accountUpdate);
            db.SaveChanges();
        ...
        [HttpPost]
        public IHttpActionResult UpdateScore(ScoreModel scoreModel)
        {
            if (!ModelState.IsValid)
            {
